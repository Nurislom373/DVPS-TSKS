...
import org.khasanof.ratelimitingwithspring.core.strategy.YamlReadStrategy;
...
public class RateLimitingService implements CommandLineRunner {
    ...
    @Autowired
    private YamlReadStrategy yamlConfig;
    ...
    public void run(String... args) throws Exception {
        List<ReadLimit> limitedPaths = limitsAdapter.getLimits();
        limitedPaths.forEach(System.out::println);
