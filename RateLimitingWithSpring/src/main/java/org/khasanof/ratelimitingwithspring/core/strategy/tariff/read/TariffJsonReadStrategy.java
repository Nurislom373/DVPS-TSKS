 ...
 */
@Slf4j
@Service(TariffJsonReadStrategy.SERVICE_NAME)
public class TariffJsonReadStrategy extends TariffReadStrategy {

    public static final String SERVICE_NAME = "tariff" + JSON + READ_STRATEGY;
