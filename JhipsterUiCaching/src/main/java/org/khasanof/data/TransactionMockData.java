...
public class TransactionMockData {
    ...
    public List<Transaction> getMockList(String jsonPath, String cardNumber) {
        ...
        try (InputStream inputStream = getClass().getResourceAsStream(jsonPath)) {
            List<Transaction> list = objectMapper.readValue(inputStream, reference);
    ...
    private void writeCardNumbers(List<String> list, String cardNum) {
        ...
        String absolutePath = "D:\\Nurislom\\Projects\\DVPS-TSKS\\JhipsterUiCaching\\src\\main\\resources\\data\\";
