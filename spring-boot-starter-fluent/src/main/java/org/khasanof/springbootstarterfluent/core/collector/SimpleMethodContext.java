...
@Getter
@Component
@DependsOn(value = {FluentConfigRunner.NAME})
public class SimpleMethodContext implements InitializingBean, MethodContext {
    ...
    public SimpleMethodContext(ResourceLoader resourceLoader, MethodCheckerAdapter checkerAdapter, ApplicationEventPublisher eventPublisher) {
    ...
    @Override
    public Map<Method, Object> getMethodsWithHandleClass(HandleClasses classes) {
