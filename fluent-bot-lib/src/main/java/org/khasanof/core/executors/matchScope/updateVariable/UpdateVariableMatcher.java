...
public class UpdateVariableMatcher {
	...
	protected String[] tokenizePath(String path) {
		return BaseUtils.tokenizeToStringArray(path, this.pathSeparator, this.trimTokens, true);
	}
	...
	public String extractPathWithinPattern(String pattern, String path) {
		String[] patternParts = BaseUtils.tokenizeToStringArray(pattern, this.pathSeparator, this.trimTokens, true);
		String[] pathParts = BaseUtils.tokenizeToStringArray(path, this.pathSeparator, this.trimTokens, true);
	...
	public String combine(String pattern1, String pattern2) {
		if (!BaseUtils.hasText(pattern1) && !BaseUtils.hasText(pattern2)) {
			return "";
		}
		if (!BaseUtils.hasText(pattern1)) {
			return pattern2;
		}
		if (!BaseUtils.hasText(pattern2)) {
			return pattern1;
		}
